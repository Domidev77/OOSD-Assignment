...
public class AccommodationData {
    ...
    List<Room> studentVillageRooms = Arrays.asList(
            ...
            new Room(102, 850.0, "Offline", "Single bedroom with en-suite", null),
            new Room(103, 550.0, "Clean", "Single bedroom with en-suite, nice view", new Lease(3, 12, new Student("Victoria Baker", 20010011)))
    );
    //-------------------------------------------------------
    ...
    List<Room> wallscourtParkRooms = Arrays.asList(
            new Room(201, 500.0, "Clean", "Single bedroom with en-suite", new Lease(1, 12, new Student("Jason Holland", 20010012))),
            new Room(202, 850.0, "Clean", "Single bedroom with en-suite", new Lease(2, 12, new Student("Anne Doe", 20010013))),
